...
import { HouseIcon, HeartIcon, HammerIcon, DotsThreeCircleIcon } from '@phosphor-icons/react'
...
const NAV_ITEMS = [
  ...
  { icon: HammerIcon, label: '공사중', href: '/wip1' },
  { icon: HammerIcon, label: '공사중', href: '/wip2' },
  { icon: DotsThreeCircleIcon, label: '메뉴', href: '/menu' },
] as const
