  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          'bg-popover text-popover-foreground z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-32 origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-xl p-1 shadow-lg',
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        'data-[variant=destructive]:active:bg-destructive/15 dark:data-[variant=destructive]:active:bg-destructive/25',
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        'bg-popover text-popover-foreground z-50 min-w-32 origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-md p-1 shadow-lg',
        'data-[state=open]:animate-dropdown-in',
        'data-[state=closed]:animate-dropdown-out',
        className
      )}
